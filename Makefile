...
.PHONY: flash-all
flash-all:
	# Upload all device configurations
...
.PHONY: build_artifact_tracibility
...
help:
	...
	@echo "  all          - Compile all device configurations"
	@echo "  flash-all    - Upload all device configurations"
	@echo "  clean        - Remove build directories"
	@echo "  clean-all    - Remove build directories and virtual environment"
